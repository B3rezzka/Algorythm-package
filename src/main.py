...
if __name__ == "__main__":
    ...
    print(f"Случайный массив [0, 100]: {rand_int_array(10, 0, 100, seed=42)}")
    print(f"Почти отсортированный: {nearly_sorted(10, 3, seed=42)}")
    print(f"С дубликатами: {many_duplicates(10, k_unique=3, seed=42)}")
    print(f"Обратно отсортированный: {reverse_sorted(10)}")
    print(f"Случайный float [0, 1): {rand_float_array(5, seed=42)}")
